...
class MemBrainPrefixHelloWorld(Protocol):
    """
    ...
    def _insertAllSteps(self):
        ...
        self._insertFunctionStep(self.runMembrainCommandStep)
        self._insertFunctionStep('createOutputStep')


    def runMembrainCommandStep(self):

        # Activates and run pip list
        self.runJob(Plugin.getProgram("pip"), "list")
